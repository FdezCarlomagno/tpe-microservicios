package tpe.microservicios.accounts_service.exceptions.handler;

import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.ControllerAdvice;
import org.springframework.web.bind.annotation.ExceptionHandler;
import tpe.microservicios.accounts_service.exceptions.BadRequestException;
import tpe.microservicios.accounts_service.exceptions.ConflictException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleForbidden(ConflictException ex) {
